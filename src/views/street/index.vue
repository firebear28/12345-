  ...
  <div class="app-container">
    <div class="filter-container">
      <!-- <div class="filter-items">
        <span>镇街编码：</span>
        <el-input v-model="listQuery.streetId" placeholder="请输入" class="filter-item" @keyup.enter.native="handleFilter"/>
      </div>
      <div class="filter-items">
        <span>镇街名称：</span>
        <el-input v-model="listQuery.streetName" placeholder="请输入" class="filter-item" @keyup.enter.native="handleFilter"/>
      </div> -->
      <div class="filter-items">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" class="dataForm" :rules="rules" :model="temp" label-position="left" label-width="140px">
        <el-form-item label="镇街编码：" prop="streetId">
          <span v-if="dialogStatus === 'update'">{{ temp.streetId }}</span>
          <el-input v-else v-model="temp.streetId"/>
        </el-form-item>
        <el-form-item label="镇街名称：" prop="streetName">
          <el-input v-model="temp.streetName"/>
        </el-form-item>
        <el-form-item label="镇街所在地：" prop="streetName">
          <el-input v-model="temp.streetName"/>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDownload() {
      ...
      window.location.href = 'http://12345v2.dgdatav.com:6080/api/sg/base/sgStreet/export?' + params
